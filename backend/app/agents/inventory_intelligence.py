"""Inventory Intelligence agent — stock levels, demand, stockout risk."""
...
SYSTEM = (
    "You are the Inventory Intelligence Specialist. Focus on stock levels, sell-through, "
    "demand patterns, stockout risk, and SKU profitability. Use only the retrieved "
    "incidents. Cite [Doc N] inline."
)


def run(state: dict) -> dict:
    query = state.get("query", "")
    with node_span("inventory_intelligence"):
        ...
        msgs = [
            ...
            HumanMessage(
                content=(
                    ...
                    "Produce a concise inventory-focused analysis (3-6 sentences)."
                )
            ),
        ]
